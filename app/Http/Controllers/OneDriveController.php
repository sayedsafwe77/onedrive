...
class OneDriveController extends Controller
{
  public function onedrive()
  {
    ...
    $getEventsUrl = "/me/drive/root/children";
    ...
    $project_ids = $this->saveProjects($viewData['events']);
    $viewData['projects'] = $project_ids;
  ...
  public function saveProjects($projects)
  {
    $project_ids = [];
        foreach ($projects as $project) {
            ...
            Project::where('project_id', $project->getId())->firstOrCreate([
